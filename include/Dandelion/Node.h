...
public:  // Public methods
  ...
  void
  resizeControlInputPort(uint32_t _s) {
    this->port_control.control_input_port.resize(_s);
  }
  void
  resizeControlOutputPort(uint32_t _s) {
  ...
  auto
  output_data_range() {
    return helpers::make_range(outputDataport_begin(), outputDataport_end());
  }
...
public:
  ...
  virtual std::string
  printOutputEnable(PrintType, PortEntry) {
    return this->info.Name + std::string(" EnableInput with ID Not defined!");
  }
  virtual std::string
  printInputData(PrintType) {
...
public:
  explicit SuperNode(NodeInfo _nf, llvm::BasicBlock* _bb = nullptr)
    : Node(Node::SuperNodeTy, _nf), basic_block(_bb), type(SuperNodeType::NoMask) {}
  ...
  auto
  phi_begin() {
    return this->phi_list.begin();
  }
  auto
  phi_end() {
    return this->phi_list.end();
  }
  auto
  phis() {
    return helpers::make_range(phi_begin(), phi_end());
  }

  auto
  ins_begin() const {
    return this->instruction_list.begin();
  }
  auto
  ins_end() const {
    return this->instruction_list.end();
  }
  auto
  instructions() {
    return helpers::make_range(ins_begin(), ins_end());
  }

  auto
  const_int_begin() const {
    return this->const_int_list.begin();
  }
  auto
  const_int_end() const {
    return this->const_int_list.end();
  }
  auto
  cints() {
  ...
  auto
  const_fp_begin() const {
    return this->const_fp_list.begin();
  }
  auto
  const_fp_end() const {
    return this->const_fp_list.end();
  }
  auto
  cfps() {
...
public:
  ...
  uint32_t
  getContainerType() const {
    return con_type;
  }

  ArgumentNode* insertLiveInArgument(llvm::Value* Value, ArgumentNode::ArgumentType Type);
  ...
  auto
  live_in_begin() {
    return this->live_in.begin();
  }
  auto
  live_in_end() {
    return this->live_in.end();
  }

  auto
  live_in_ptrs_begin() {
    return this->live_in_ptrs.begin();
  }
  auto
  live_in_ptrs_end() {
    return this->live_in_ptrs.end();
  }
  ...
  auto
  live_out_begin() {
    return this->live_out.begin();
  }
  auto
  live_out_end() {
    return this->live_out.end();
  }
  auto
  live_out_lists() {
  ...
  auto
  carry_depen_begin() {
    return this->carry_depen.begin();
  }
  auto
  carry_depen_end() {
    return this->carry_depen.end();
  }
  auto
  carry_depen_lists() {
...
public:
  ...
  virtual PortID
  addDataInputPort(Node*) override {
    assert(!"You are not supposed to call this function!");
    return PortID();
  }
  virtual PortID
  addDataOutputPort(Node*) override {
    assert(!"You are not supposed to call this function!");
    return PortID();
  };
...
public:
  ...
  explicit ScratchpadNode(NodeInfo _nf,
                          AllocaNode* alloca,
                          uint32_t mem_size,
                          uint32_t mem_byte)
...
public:
  ...
  explicit LoopNode(NodeInfo _nf, LoopNode* _p_l, SuperNode* _hnode, SuperNode* _lnode)
    : ContainerNode(_nf, ContainerNode::LoopNodeTy),
      parent_loop(_p_l),
      head_node(_hnode),
      latch_node(_lnode),
  ...
  auto
  bb_begin() {
    return basic_block_list.begin();
  }
  auto
  bb_end() {
    return basic_block_list.end();
  }
  auto
  bblocks() {
    return helpers::make_range(bb_begin(), bb_end());
  }

  // Iterator over ending instructions
  auto
  ending_begin() {
    return ending_instructions.begin();
  }
  auto
  ending_end() {
    return ending_instructions.end();
  }
  auto
  endings() {
    return helpers::make_range(ending_begin(), ending_end());
  }

  // Iterator over input edges

  void
  setHeadNode(SuperNode* _n) {
    head_node = _n;
  }
  void
  setLatchNode(SuperNode* _n) {
    latch_node = _n;
  }

  void
  setIndeuctionVariable(InstructionNode* I) {
    this->induction_variable = I;
  }
  /**
   * Make sure that loop enable signal is always set to index 0
   */
  void
  setInputControlLoopSignal(Node* _n) {
   ...
   */
  void
  setActiveOutputLoopSignal(Node* _n) {
   ...
   */
  void
  pushSuperNode(SuperNode* _n) {
    basic_block_list.push_back(_n);
  }
   ...
   */
  void
  pushInstructionNode(InstructionNode* _n) {
...
public:
  ...
  bool
  isPointerType() const {
    return data_type == Node::PointerType;
  }
  bool
  isIntegerType() const {
    return data_type == Node::IntegerType;
  }
  bool
  isFloatType() const {
    return data_type == Node::FloatType;
  }
  ...
  bool
  isBinaryOp() const {
    return ins_type == BinaryInstructionTy;
  }
  ...
  virtual std::string
  printDefinition(PrintType) override {
...
public:
  ...
  static bool
  classof(const InstructionNode* I) {
...
public:
  ...
  BranchNode(NodeInfo _ni, llvm::BranchInst* _ins = nullptr)
    : InstructionNode(_ni, InstType::BranchInstructionTy, _ins), ending_loop(false) {}

  BranchNode(NodeInfo _ni, bool _loop, llvm::BranchInst* _ins = nullptr)
    : InstructionNode(_ni, InstType::BranchInstructionTy, _ins), ending_loop(_loop) {}

  static bool
  classof(const InstructionNode* T) {
  ...
  void
  addTrueBranch(Node* _n) {
    this->output_predicate.push_back(std::make_pair(_n, PredicateResult::True));
    this->addControlOutputPort(_n);
  }
  void
  addFalseBranch(Node* _n) {
    this->output_predicate.push_back(std::make_pair(_n, PredicateResult::False));
    this->addControlOutputPort(_n);
  }
...
public:
  SelectNode(NodeInfo _ni, llvm::SelectInst* _ins = nullptr, SuperNode* _parent = nullptr)
...
public:
  ...
  PhiSelectNode(NodeInfo _ni,
                bool _rev,
                llvm::PHINode* _ins = nullptr,
  ...
  PhiSelectNode(NodeInfo _ni,
                ...
                llvm::PHINode* _ins = nullptr,
                SuperNode* _parent  = nullptr)
    : InstructionNode(_ni, InstType::PhiInstructionTy, _type, _ins), reverse(_rev) {}
...
public:
  ...
  AllocaNode(NodeInfo _ni,
             ...
             uint32_t rid           = 0,
             llvm::AllocaInst* _ins = nullptr)
    : InstructionNode(_ni, InstructionNode::AllocaInstructionTy, _type, _ins),
      size(_size),
      num_byte(_num_byte) {}
...
public:
  ...
  explicit GepNode(NodeInfo _ni,
                   common::GepInfo _info,
                   llvm::GetElementPtrInst* _ins = nullptr)
    : InstructionNode(_ni, InstructionNode::GetElementPtrInstTy, _ins), gep_info(_info) {}

  explicit GepNode(NodeInfo _ni,
                   DataType _type,
                   common::GepInfo _info,
                   llvm::GetElementPtrInst* _ins = nullptr)
    : InstructionNode(_ni, InstructionNode::GetElementPtrInstTy, _type, _ins),
      gep_info(_info) {}
...
public:
  LoadNode(NodeInfo _ni,
           llvm::LoadInst* _ins = nullptr,
...
public:
  StoreNode(NodeInfo _ni,
            llvm::StoreInst* _ins = nullptr,
...
public:
  ReturnNode(NodeInfo _ni, llvm::ReturnInst* _ins = nullptr, NodeType _nd = UnkonwTy)
...
public:
  CallNode(NodeInfo _ni, llvm::CallInst* _ins = nullptr, NodeType _nd = UnkonwTy)
    : InstructionNode(_ni, InstructionNode::CallInstructionTy, _ins) {
    call_in =
        std::make_unique<CallInNode>(NodeInfo(_ni.Name + "_in", _ni.ID), this, _ins);
    call_out =
        std::make_unique<CallOutNode>(NodeInfo(_ni.Name + "_out", _ni.ID), this, _ins);
  }
...
public:
  CallInNode(NodeInfo _ni,
             CallNode* _parent,
             llvm::CallInst* _ins = nullptr,
...
public:
  explicit SplitCallNode(NodeInfo _nf) : ContainerNode(_nf, ContainerNode::SplitCallTy) {}

  static bool
  classof(const ContainerNode* T) {
...
public:
  DetachNode(NodeInfo _ni, llvm::DetachInst* _ins = nullptr, NodeType _nd = UnkonwTy)
...
public:
  SextNode(NodeInfo _ni, llvm::SExtInst* _ins = nullptr, NodeType _nd = UnkonwTy)
...
public:
  ZextNode(NodeInfo _ni, llvm::ZExtInst* _ins = nullptr, NodeType _nd = UnkonwTy)
...
public:
  TruncNode(NodeInfo _ni, llvm::TruncInst* _ins = nullptr, NodeType _nd = UnkonwTy)
...
public:
  STIoFPNode(NodeInfo _ni, llvm::SIToFPInst* _ins = nullptr, NodeType _nd = UnkonwTy)
...
public:
  FPToUINode(NodeInfo _ni, llvm::FPToUIInst* _ins = nullptr, NodeType _nd = UnkonwTy)
...
public:
  ReattachNode(NodeInfo _ni, llvm::ReattachInst* _ins = nullptr, NodeType _nd = UnkonwTy)
...
public:
  SyncNode(NodeInfo _ni, llvm::SyncInst* _ins = nullptr, NodeType _nd = UnkonwTy)
...
public:
  BitcastNode(NodeInfo _ni, llvm::BitCastInst* _ins = nullptr, NodeType _nd = UnkonwTy)
