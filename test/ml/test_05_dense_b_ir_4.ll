; ModuleID = './test_05_dense_b_ir_4.bc'
source_filename = "./05_dense_b_ir_4.bc"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux_gnu"

define void @test_05_dense_b_ir_4(i8* nocapture align 8 dereferenceable(8) %retval, i8* noalias nocapture readnone %run_options, i8** noalias nocapture readonly %params, i8** noalias nocapture readonly %temps, i64* noalias nocapture readnone %prof_counters) #0 {
dot.loop_body.rhs.1.lr.ph:
  ...
  %1 = bitcast i8* %arg1.untyped to [1 x [64 x float]]*
...
dot.loop_exit.reduction:                          ; preds = %dot.loop_exit.reduction, %dot.loop_body.rhs.1.lr.ph
  ...
  %.phi.trans.insert = getelementptr inbounds [1 x [64 x float]], [1 x [64 x float]]* %1, i64 0, i64 0, i64 %dot.indvar.rhs.16
  ...
  %8 = getelementptr inbounds [1 x [64 x float]], [1 x [64 x float]]* %dot, i64 0, i64 0, i64 %dot.indvar.rhs.16
  store float %7, float* %8, align 4
  %invar.inc1 = add nuw nsw i64 %dot.indvar.rhs.16, 1
  %9 = icmp ugt i64 %invar.inc1, 63
...
fusion.loop_body.dim.0.lr.ph:                     ; preds = %dot.loop_exit.reduction
  ...
  %fusion = bitcast i8* %10 to [64 x float]*
...
fusion.loop_body.dim.0:                           ; preds = %fusion.loop_body.dim.0, %fusion.loop_body.dim.0.lr.ph
  ...
  %11 = getelementptr inbounds [64 x float], [64 x float]* %3, i64 0, i64 %fusion.indvar.dim.02
  %12 = load float, float* %11, align 4
  %13 = getelementptr inbounds [1 x [64 x float]], [1 x [64 x float]]* %dot, i64 0, i64 0, i64 %fusion.indvar.dim.02
  %14 = load float, float* %13, align 4
  %15 = fadd float %12, %14
  %16 = getelementptr inbounds [64 x float], [64 x float]* %fusion, i64 0, i64 %fusion.indvar.dim.02
  store float %15, float* %16, align 4
  %invar.inc3 = add nuw nsw i64 %fusion.indvar.dim.02, 1
  %17 = icmp ugt i64 %invar.inc3, 63
