...
define i32 @test09(i32 %j) #0 !dbg !7 {
entry:
...
for.body:                                         ; preds = %for.cond
  %add = add i32 %i.0, 1, !dbg !25
  call void @llvm.dbg.value(metadata i32 %add, i64 0, metadata !14, metadata !12), !dbg !15
  br label %for.inc, !dbg !27

for.inc:                                          ; preds = %for.body
  %inc = add i32 %i.0, 1, !dbg !28
  call void @llvm.dbg.value(metadata i32 %inc, i64 0, metadata !16, metadata !12), !dbg !18
...
entry:
  %call = call i32 @test09(i32 100), !dbg !39
...
!1 = !DIFile(filename: "test09.c", directory: "/home/amiralis/git/xketch-generator/test/c")
!2 = !{}
!3 = !{i32 1, !"NumRegisterParameters", i32 0}
!4 = !{i32 2, !"Dwarf Version", i32 4}
!5 = !{i32 2, !"Debug Info Version", i32 3}
!6 = !{!"clang version 4.0.1 (tags/RELEASE_401/final)"}
!7 = distinct !DISubprogram(name: "test09", scope: !1, file: !1, line: 3, type: !8, isLocal: false, isDefinition: true, scopeLine: 3, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
...
!25 = !DILocation(line: 6, column: 10, scope: !26)
