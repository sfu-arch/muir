...
entry:
  ...
  %1 = bitcast i32* %b.addr to i8*
  %call = call i8* @Mat(i8* %0, i8* %1)
  ret i8* %call
}

declare i8* @Mat(i8*, i8*) #1

; Function Attrs: noinline nounwind
define i32 @main() #0 {
entry:
  %call = call i8* @foo(i32 5, i32 3)
  ret i32 0
}
