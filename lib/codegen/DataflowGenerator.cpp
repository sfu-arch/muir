...
std::string DataflowGeneratorPass::PrintCallResp(Instruction &Ins,
                                                 uint32_t num) {
                        ...
                        if (p == search_elem.first) {
                            ...
                            if (operand_arg) {
                                ...
                                string command =
                                    ...
                                    "(param.{{operand_name}}_in(\"{{instruction_name}}\"))\n";
