...
extern halide_error_handler_t halide_set_error_handler(
...
extern void halide_cond_signal(struct halide_cond *cond);
extern void halide_cond_wait(struct halide_cond *cond,
...
typedef int (*halide_task_t)(void *user_context, int task_number,
                             uint8_t *closure);
extern int halide_do_par_for(void *user_context, halide_task_t task, int min,
                             int size, uint8_t *closure);
...
extern halide_do_par_for_t halide_set_custom_do_par_for(
    halide_do_par_for_t do_par_for);

/** An opaque struct representing a semaphore. Used by the task system for async
 * tasks. */
...
typedef bool (*halide_semaphore_try_acquire_t)(struct halide_semaphore_t *,
                                               int);
...
struct halide_parallel_task_t {
    ...
    // The calls to the function should be in serial order from min to
    // min+extent-1, with only one executing at a time. If false, any order is
    // fine, and concurrency is fine.
    bool serial;
};
...
// @{
typedef int (*halide_do_loop_task_t)(void *, halide_loop_task_t, int, int,
                                     uint8_t *, void *);
extern halide_do_loop_task_t halide_set_custom_do_loop_task(
    halide_do_loop_task_t do_task);
extern int halide_do_loop_task(void *user_context, halide_loop_task_t f,
...
// @{
typedef int (*halide_do_parallel_tasks_t)(void *, int,
                                          struct halide_parallel_task_t *,
                                          void *task_parent);
extern void halide_set_custom_parallel_runtime(
    halide_do_par_for_t, halide_do_task_t, halide_do_loop_task_t,
    halide_do_parallel_tasks_t, halide_semaphore_init_t,
    halide_semaphore_try_acquire_t, halide_semaphore_release_t);
// @}

/** The default versions of the parallel runtime functions. */
// @{
extern int halide_default_do_par_for(void *user_context, halide_task_t task,
                                     int min, int size, uint8_t *closure);
extern int halide_default_do_parallel_tasks(
    void *user_context, int num_tasks, struct halide_parallel_task_t *tasks,
    void *task_parent);
...
extern bool halide_default_semaphore_try_acquire(struct halide_semaphore_t *,
                                                 int n);
// @}
...
extern struct halide_thread *halide_spawn_thread(void (*f)(void *),
                                                 void *closure);
 ...
 * the halide_set_custom_load_library() and
 * halide_set_custom_get_library_symbol() functions. In JIT-compiled code, use
 * JITSharedRuntime::set_default_handlers().
 *
...
extern halide_get_symbol_t halide_set_custom_get_symbol(
    halide_get_symbol_t user_get_symbol);
extern halide_load_library_t halide_set_custom_load_library(
    halide_load_library_t user_load_library);
extern halide_get_library_symbol_t halide_set_custom_get_library_symbol(
    halide_get_library_symbol_t user_get_library_symbol);
//@}
...
struct halide_type_t {
    /** The basic type code: signed integer, unsigned integer, or floating
     * point. */
#if __cplusplus >= 201103L
    ...
    HALIDE_ALWAYS_INLINE halide_type_t(halide_type_code_t code, uint8_t bits,
                                       uint16_t lanes = 1)
    ...
    /** Size in bytes for a single element, even if width is not 1, of this
     * type. */
 ...
 * meaningful.
 *
 * Note that all trace_tag events (if any) will occur just after the
 * begin_pipeline event, but before any begin_realization events. All trace_tags
 * for a given Func will be emitted in the order added.
 */
// @}
extern int32_t halide_trace(void *user_context,
                            const struct halide_trace_event_t *event);
extern int32_t halide_default_trace(void *user_context,
                                    const struct halide_trace_event_t *event);
typedef int32_t (*halide_trace_t)(void *user_context,
                                  const struct halide_trace_event_t *);
...
struct halide_trace_packet_t {
    ...
    HALIDE_ALWAYS_INLINE int *coordinates() { return (int *)(this + 1); }
     ...
     * as it was written. It comes after the func name. If there is no
     * trace_tag, this will return a pointer to an empty string. */
...
struct halide_device_interface_t {
    int (*device_malloc)(
        void *user_context, struct halide_buffer_t *buf,
    ...
    int (*copy_to_device)(
        void *user_context, struct halide_buffer_t *buf,
        const struct halide_device_interface_t *device_interface);
    int (*device_and_host_malloc)(
        void *user_context, struct halide_buffer_t *buf,
        const struct halide_device_interface_t *device_interface);
    int (*device_and_host_free)(void *user_context,
                                struct halide_buffer_t *buf);
    int (*buffer_copy)(
        void *user_context, struct halide_buffer_t *src,
    ...
    int (*wrap_native)(
        void *user_context, struct halide_buffer_t *buf, uint64_t handle,
        const struct halide_device_interface_t *device_interface);
 ...
 * calling this. */
extern void halide_device_release(
    void *user_context,
    const struct halide_device_interface_t *device_interface);
 ...
 * error is returned. */
extern int halide_copy_to_device(
    void *user_context, struct halide_buffer_t *buf,
    const struct halide_device_interface_t *device_interface);
 ...
 * device_dirty flag only. Only supported by some device APIs (others will
 * return halide_error_code_device_crop_unsupported). Call
 * halide_device_release_crop instead of halide_device_free to clean
 * up resources associated with the sliced view. Do not free the
 * device allocation on the source buffer while the destination buffer
 * still lives. Note that the two buffers do not share dirty flags, so
 * care must be taken to update them together as needed. Note that the dst
 * buffer must have exactly one fewer dimension than the src buffer, and that
 * slice_dim and slice_pos must be valid within src. */
extern int halide_device_slice(void *user_context,
                               const struct halide_buffer_t *src, int slice_dim,
                               int slice_pos, struct halide_buffer_t *dst);
...
extern int halide_device_malloc(
    void *user_context, struct halide_buffer_t *buf,
    const struct halide_device_interface_t *device_interface);
...
// @{
extern int halide_device_wrap_native(
    void *user_context, struct halide_buffer_t *buf, uint64_t handle,
    const struct halide_device_interface_t *device_interface);
extern int halide_device_detach_native(void *user_context,
                                       struct halide_buffer_t *buf);
// @}
...
extern int halide_copy_to_device_legacy(
    void *user_context, struct buffer_t *buf,
    const struct halide_device_interface_t *device_interface);
extern int halide_device_sync_legacy(void *user_context, struct buffer_t *buf);
extern int halide_device_malloc_legacy(
    void *user_context, struct buffer_t *buf,
    const struct halide_device_interface_t *device_interface);
 ...
 */
extern int halide_memoization_cache_lookup(
    void *user_context, const uint8_t *cache_key, int32_t size,
    struct halide_buffer_t *realized_bounds, int32_t tuple_count,
 ...
 */
extern int halide_memoization_cache_store(
    void *user_context, const uint8_t *cache_key, int32_t size,
    struct halide_buffer_t *realized_bounds, int32_t tuple_count,
    struct halide_buffer_t **tuple_buffers);
...
/** Create a unique file with a name of the form prefixXXXXXsuffix in an
 * arbitrary (but writable) directory; this is typically $TMP or /tmp, but the
 * specific location is not guaranteed. (Note that the exact form of the file
 * name may vary; in particular, the suffix may be ignored on non-Posix
 * systems.) The file is created (but not opened), thus this can be called from
 ...
 */
extern int halide_create_temp_file(void *user_context, const char *prefix,
                                   const char *suffix, char *path_buf,
                                   size_t path_buf_size);

/** Annotate that a given range of memory has been initialized;
 * only used when Target::MSAN is enabled.
 *
 * The default implementation uses the LLVM-provided
 * AnnotateMemoryIsInitialized() function.
 */
extern void halide_msan_annotate_memory_is_initialized(void *user_context,
                                                       const void *ptr,
                                                       uint64_t len);

/** Mark the data pointed to by the buffer_t as initialized (but *not* the
 * buffer_t itself), using halide_msan_annotate_memory_is_initialized() for
 * marking.
 *
 * The default implementation takes pains to only mark the active memory ranges
 * (skipping padding), and sorting into ranges to always mark the smallest
 * number of ranges, in monotonically increasing memory order.
 *
 * Most client code should never need to replace the default implementation.
 */
extern void halide_msan_annotate_buffer_is_initialized(
    void *user_context, struct halide_buffer_t *buffer);
extern void halide_msan_annotate_buffer_is_initialized_as_destructor(
    void *user_context, void *buffer);
...
enum halide_error_code_t {
    ...
    /** An uncategorized error occurred. Refer to the string passed to
       halide_error. */
    ...
    /** The dimensions field of a halide_buffer_t does not match the dimensions
       of that ImageParam. */
...
// extern int halide_error_bounds_inference_call_failed(void *user_context,
// const char *extern_stage_name, int result);

// /** A call to an extern stage failed. Returned the error code given by
//  * the extern stage. */
// extern int halide_error_extern_stage_failed(void *user_context, const char
// *extern_stage_name, int result);

// /** Various other error conditions. See the enum above for a
//  * description of each. */
// // @{
// extern int halide_error_explicit_bounds_too_small(void *user_context, const
// char *func_name, const char *var_name,
//                                                       int min_bound, int
//                                                       max_bound, int
//                                                       min_required, int
//                                                       max_required);
...
//                                  uint16_t lanes_given, uint16_t
//                                  correct_lanes);
// extern int halide_error_bad_dimensions(void *user_context, const char
// *func_name,
//                                        int32_t dimensions_given, int32_t
//                                        correct_dimensions);
// extern int halide_error_access_out_of_bounds(void *user_context, const char
// *func_name,
//                                              int dimension, int min_touched,
//                                              int max_touched, int min_valid,
//                                              int max_valid);
// extern int halide_error_buffer_allocation_too_large(void *user_context, const
// char *buffer_name,
//                                                     uint64_t allocation_size,
//                                                     uint64_t max_size);
// extern int halide_error_buffer_extents_negative(void *user_context, const
// char *buffer_name, int dimension, int extent); extern int
// halide_error_buffer_extents_too_large(void *user_context, const char
// *buffer_name,
//                                                  int64_t actual_size, int64_t
//                                                  max_size);
// extern int halide_error_constraints_make_required_region_smaller(void
// *user_context, const char *buffer_name,
//                                                                  int
//                                                                  dimension,
//                                                                  int
//                                                                  constrained_min,
...
//                                                                  int
//                                                                  required_extent);
// extern int halide_error_constraint_violated(void *user_context, const char
// *var, int val,
//                                             const char *constrained_var, int
//                                             constrained_val);
// extern int halide_error_param_too_small_i64(void *user_context, const char
// *param_name,
//                                             int64_t val, int64_t min_val);
// extern int halide_error_param_too_small_u64(void *user_context, const char
// *param_name,
//                                             uint64_t val, uint64_t min_val);
// extern int halide_error_param_too_small_f64(void *user_context, const char
// *param_name,
//                                             double val, double min_val);
// extern int halide_error_param_too_large_i64(void *user_context, const char
// *param_name,
//                                             int64_t val, int64_t max_val);
// extern int halide_error_param_too_large_u64(void *user_context, const char
// *param_name,
//                                             uint64_t val, uint64_t max_val);
// extern int halide_error_param_too_large_f64(void *user_context, const char
// *param_name,
//                                             double val, double max_val);
// extern int halide_error_out_of_memory(void *user_context);
// extern int halide_error_buffer_argument_is_null(void *user_context, const
// char *buffer_name); extern int halide_error_debug_to_file_failed(void
// *user_context, const char *func,
//                                              const char *filename, int
//                                              error_code);
// extern int halide_error_unaligned_host_ptr(void *user_context, const char
// *func_name, int alignment); extern int halide_error_host_is_null(void
// *user_context, const char *func_name); extern int
// halide_error_failed_to_upgrade_buffer_t(void *user_context,
//                                                    const char *input_name,
//                                                    const char *reason);
// extern int halide_error_failed_to_downgrade_buffer_t(void *user_context,
//                                                      const char *input_name,
//                                                      const char *reason);
// extern int halide_error_bad_fold(void *user_context, const char *func_name,
// const char *var_name,
//                                  const char *loop_name);
// extern int halide_error_bad_extern_fold(void *user_context, const char
// *func_name,
//                                         int dim, int min, int extent, int
//                                         valid_min, int fold_factor);

// extern int halide_error_fold_factor_too_small(void *user_context, const char
// *func_name, const char *var_name,
//                                               int fold_factor, const char
//                                               *loop_name, int
//                                               required_extent);
// extern int halide_error_requirement_failed(void *user_context, const char
// *condition, const char *message); extern int
// halide_error_specialize_fail(void *user_context, const char *message); extern
// int halide_error_no_device_interface(void *user_context); extern int
// halide_error_device_interface_no_device(void *user_context); extern int
// halide_error_host_and_device_dirty(void *user_context); extern int
// halide_error_buffer_is_null(void *user_context, const char *routine); extern
// int halide_error_integer_division_by_zero(void *user_context);
// @}

/** Optional features a compilation Target can have.
 */
typedef enum halide_target_feature_t {
    halide_target_feature_jit = 0,  ///< Generate code that will run immediately
                                    ///< inside the calling process.
    halide_target_feature_debug =
        1,  ///< Turn on debug info and output for runtime code.
    halide_target_feature_no_asserts =
        2,  ///< Disable all runtime checks, for slightly tighter code.
    halide_target_feature_no_bounds_query =
        3,  ///< Disable the bounds querying functionality.

    halide_target_feature_sse41 =
        4,  ///< Use SSE 4.1 and earlier instructions. Only relevant on x86.
    halide_target_feature_avx =
        5,  ///< Use AVX 1 instructions. Only relevant on x86.
    halide_target_feature_avx2 =
        6,  ///< Use AVX 2 instructions. Only relevant on x86.
    ...
    halide_target_feature_armv7s =
        10,  ///< Generate code for ARMv7s. Only relevant for 32-bit ARM.
    halide_target_feature_no_neon =
        11,  ///< Avoid using NEON instructions. Only relevant for 32-bit ARM.

    halide_target_feature_vsx =
        12,  ///< Use VSX instructions. Only relevant on POWERPC.
    halide_target_feature_power_arch_2_07 =
        13,  ///< Use POWER ISA 2.07 new instructions. Only relevant on POWERPC.

    halide_target_feature_cuda = 14,  ///< Enable the CUDA runtime. Defaults to
                                      ///< compute capability 2.0 (Fermi)
    halide_target_feature_cuda_capability30 =
        15,  ///< Enable CUDA compute capability 3.0 (Kepler)
    halide_target_feature_cuda_capability32 =
        16,  ///< Enable CUDA compute capability 3.2 (Tegra K1)
    halide_target_feature_cuda_capability35 =
        17,  ///< Enable CUDA compute capability 3.5 (Kepler)
    halide_target_feature_cuda_capability50 =
        18,  ///< Enable CUDA compute capability 5.0 (Maxwell)

    halide_target_feature_opencl = 19,  ///< Enable the OpenCL runtime.
    halide_target_feature_cl_doubles =
        20,  ///< Enable double support on OpenCL targets

    halide_target_feature_opengl = 21,  ///< Enable the OpenGL runtime.
    halide_target_feature_openglcompute =
        22,  ///< Enable OpenGL Compute runtime.

    halide_target_feature_unused_23 =
        23,  ///< Unused. (Formerly: Enable the RenderScript runtime.)

    halide_target_feature_user_context =
        24,  ///< Generated code takes a user_context pointer as first argument

    halide_target_feature_matlab =
        25,  ///< Generate a mexFunction compatible with Matlab mex libraries.
             ///< See tools/mex_halide.m.

    halide_target_feature_profile =
        26,  ///< Launch a sampling profiler alongside the Halide pipeline that
             ///< monitors and reports the runtime used by each Func
    halide_target_feature_no_runtime =
        27,  ///< Do not include a copy of the Halide runtime in any generated
             ///< object file or assembly

    halide_target_feature_metal = 28,  ///< Enable the (Apple) Metal runtime.
    halide_target_feature_mingw =
        29,  ///< For Windows compile to MinGW toolset rather then Visual Studio

    halide_target_feature_c_plus_plus_mangling =
        30,  ///< Generate C++ mangled names for result function, et al

    halide_target_feature_large_buffers =
        31,  ///< Enable 64-bit buffer indexing to support buffers > 2GB.
             ///< Ignored if bits != 64.
    ...
    halide_target_feature_fuzz_float_stores =
        35,  ///< On every floating point store, set the last bit of the
             ///< mantissa to zero. Pipelines for which the output is very
             ///< different with this feature enabled may also produce very
             ///< different output on different processors.
    halide_target_feature_soft_float_abi =
        36,  ///< Enable soft float ABI. This only enables the soft float ABI
             ///< calling convention, which does not necessarily use soft
             ///< floats.
    halide_target_feature_msan = 37,  ///< Enable hooks for MSAN support.
    halide_target_feature_avx512 =
        38,  ///< Enable the base AVX512 subset supported by all AVX512
    ...
    halide_target_feature_avx512_knl =
        39,  ///< Enable the AVX512 features supported by Knight's Landing
             ///< chips, such as the Xeon Phi x200. This includes the base
             ///< AVX512 set, and also AVX512-CD and AVX512-ER.
    halide_target_feature_avx512_skylake =
        40,  ///< Enable the AVX512 features supported by Skylake Xeon server
             ///< processors. This adds AVX512-VL, AVX512-BW, and AVX512-DQ to
             ///< the base set. The main difference from the base AVX512 set is
             ///< better support for small integer ops. Note that this does not
             ///< include the Knight's Landing features. Note also that these
             ///< features are not available on Skylake desktop and mobile
             ///< processors.
    halide_target_feature_avx512_cannonlake =
        41,  ///< Enable the AVX512 features expected to be supported by future
             ///< Cannonlake processors. This includes all of the Skylake
             ///< features, plus AVX512-IFMA and AVX512-VBMI.
    halide_target_feature_hvx_use_shared_object = 42,  ///< Deprecated
    halide_target_feature_trace_loads =
        43,  ///< Trace all loads done by the pipeline. Equivalent to calling
             ///< Func::trace_loads on every non-inlined Func.
    halide_target_feature_trace_stores =
        44,  ///< Trace all stores done by the pipeline. Equivalent to calling
             ///< Func::trace_stores on every non-inlined Func.
    halide_target_feature_trace_realizations =
        45,  ///< Trace all realizations done by the pipeline. Equivalent to
             ///< calling Func::trace_realizations on every non-inlined Func.
    halide_target_feature_cuda_capability61 =
        46,  ///< Enable CUDA compute capability 6.1 (Pascal)
    ...
    halide_target_feature_cl_half =
        49,  ///< Enable half support on OpenCL targets
    halide_target_feature_strict_float =
        50,  ///< Turn off all non-IEEE floating-point optimization. Currently
             ///< applies only to LLVM targets.
    halide_target_feature_legacy_buffer_wrappers =
        51,  ///< Emit legacy wrapper code for buffer_t (vs halide_buffer_t)
             ///< when AOT-compiled.
    ...
    halide_target_feature_d3d12compute =
        54,  ///< Enable Direct3D 12 Compute runtime.
    halide_target_feature_check_unsafe_promises =
        55,  ///< Insert assertions for promises.
    halide_target_feature_hexagon_dma = 56,  ///< Enable Hexagon DMA buffers.
    halide_target_feature_embed_bitcode =
        57,                             ///< Emulate clang -fembed-bitcode flag.
    halide_target_feature_coreir = 58,  ///< Enable output to CoreIR.
    halide_target_feature_coreir_valid =
        59,                          ///< Enable output signal valid for CoreIR.
    halide_target_feature_hls = 60,  ///< Enable output to HLS.
    halide_target_feature_end =
        61  ///< A sentinel. Every target is considered to have this feature,
            ///< and setting this feature does nothing.
 ...
 *
 * -- If there are flags set in features that the function knows *cannot* be
 * supported, return 0.
 * -- Otherwise, return 1.
 * -- Note that any flags set in features that the function doesn't know how to
 * test should be ignored; this implies that a return value of 1 means "not
 * known to be bad" rather than "known to be good".
 *
 * In other words: a return value of 0 means "It is not safe to use code
 * compiled with these features", while a return value of 1 means "It is not
 * obviously unsafe to use code compiled with these features".
 *
 * The default implementation simply calls
 * halide_default_can_use_target_features.
 *
 * Note that `features` points to an array of `count` uint64_t; this array must
 * contain enough bits to represent all the currently known features. Any excess
 * bits must be set to zero.
 */
// @{
extern int halide_can_use_target_features(int count, const uint64_t *features);
typedef int (*halide_can_use_target_features_t)(int count,
                                                const uint64_t *features);
extern halide_can_use_target_features_t
    halide_set_custom_can_use_target_features(halide_can_use_target_features_t);
// @}

/**
 * This is the default implementation of halide_can_use_target_features; it is
 * provided for convenience of user code that may wish to extend
 * halide_can_use_target_features but continue providing existing support, e.g.
 *
 *     int halide_can_use_target_features(int count, const uint64_t *features) {
 *          if (features[halide_target_somefeature >> 6] & (1LL <<
 * (halide_target_somefeature & 63))) { if (!can_use_somefeature()) { return 0;
 *              }
 *          }
 *          return halide_default_can_use_target_features(count, features);
 *     }
 */
extern int halide_default_can_use_target_features(int count,
                                                  const uint64_t *features);

typedef struct halide_dimension_t {
    int32_t min, extent, stride;

    // Per-dimension flags. None are defined yet (This is reserved for future
    // use).
    uint32_t flags;
    ...
    HALIDE_ALWAYS_INLINE halide_dimension_t(int32_t m, int32_t e, int32_t s,
                                            uint32_t f = 0)
        : min(m), extent(e), stride(s), flags(f) {}

    HALIDE_ALWAYS_INLINE bool operator==(
        const halide_dimension_t &other) const {
        return (min == other.min) && (extent == other.extent) &&
               (stride == other.stride) && (flags == other.flags);
    }
 ...
 * an old-style buffer_t into a new-style halide_buffer_t. If bounds_query_only
 * is nonzero, the copy is only done if the old_buf has null host and dev (ie, a
 * bounds query is being performed); otherwise new_buf is left untouched. (This
 * is used for input buffers to avoid benign data races.) The dimensions and
 * type fields of the new buffer_t should already be
...
extern int halide_downgrade_buffer_t_device_fields(
    void *user_context, const char *name, const halide_buffer_t *new_buf,
    buffer_t *old_buf);
...
/*
    ...
    2) All fields must land on an alignment boundary that is the same as their
   size 3) Explicit padding is added to make that so 4) The sizeof the struct is
   padded out to a multiple of the largest natural size thing in the struct 5)
   don't forget that 32 and 64 bit pointers are different sizes
*/
...
struct halide_filter_metadata_t {
     ...
     * null. The order of arguments is not guaranteed (input and output
     * arguments may come in any order); however, it is guaranteed that all
     * arguments will have a unique name within a given filter. */
...
extern struct halide_profiler_pipeline_stats *
halide_profiler_get_pipeline_state(const char *pipeline_name);
...
HALIDE_BUFFER_HELPER_ATTRS
const struct halide_device_interface_t *_halide_buffer_get_device_interface(
...
HALIDE_BUFFER_HELPER_ATTRS
halide_buffer_t *_halide_buffer_init(
    halide_buffer_t *dst, halide_dimension_t *dst_shape, void *host,
    uint64_t device, halide_device_interface_t *device_interface, int type_code,
    int type_bits, int dimensions, halide_dimension_t *shape, uint64_t flags) {
...
HALIDE_BUFFER_HELPER_ATTRS
halide_buffer_t *_halide_buffer_crop(void *user_context, halide_buffer_t *dst,
                                     halide_dimension_t *dst_shape,
                                     const halide_buffer_t *src, const int *min,
                                     const int *extent) {
    *dst = *src;
    dst->dim = dst_shape;
    int64_t offset = 0;
...
HALIDE_BUFFER_HELPER_ATTRS
halide_buffer_t *_halide_buffer_set_bounds(halide_buffer_t *buf, int dim,
                                           int min, int extent) {
    buf->dim[dim].min = min;
...
int halide_error_explicit_bounds_too_small(void *user_context,
                                           ...
                                           const char *var_name, int min_bound,
                                           int max_bound, int min_required,
                                           int max_required) {
    assert(false);
}
...
int halide_error_buffer_extents_negative(void *user_context,
                                         const char *buffer_name, int dimension,
                                         int extent) {
    assert(false);
}
...
int halide_error_constraints_make_required_region_smaller(
    void *user_context, const char *buffer_name, int dimension,
    int constrained_min, int constrained_extent, int required_min,
    int required_extent) {
    assert(false);
}
int halide_error_constraint_violated(void *user_context, const char *var,
                                     int val, const char *constrained_var,
                                     int constrained_val) {
    assert(false);
}
int halide_error_param_too_small_i64(void *user_context, const char *param_name,
                                     int64_t val, int64_t min_val) {
    assert(false);
}
int halide_error_param_too_small_u64(void *user_context, const char *param_name,
                                     uint64_t val, uint64_t min_val) {
    assert(false);
}
int halide_error_param_too_small_f64(void *user_context, const char *param_name,
                                     double val, double min_val) {
    assert(false);
}
int halide_error_param_too_large_i64(void *user_context, const char *param_name,
                                     int64_t val, int64_t max_val) {
    assert(false);
}
int halide_error_param_too_large_u64(void *user_context, const char *param_name,
                                     uint64_t val, uint64_t max_val) {
    assert(false);
}
int halide_error_param_too_large_f64(void *user_context, const char *param_name,
                                     double val, double max_val) {
    assert(false);
}
int halide_error_out_of_memory(void *user_context) { assert(false); }
int halide_error_buffer_argument_is_null(void *user_context,
                                         const char *buffer_name) {
    assert(false);
}
int halide_error_debug_to_file_failed(void *user_context, const char *func,
                                      const char *filename, int error_code) {
    assert(false);
}
int halide_error_unaligned_host_ptr(void *user_context, const char *func_name,
                                    int alignment) {
    assert(false);
}
...
int halide_error_bad_fold(void *user_context, const char *func_name,
                          const char *var_name, const char *loop_name) {
    assert(false);
}
int halide_error_bad_extern_fold(void *user_context, const char *func_name,
                                 int dim, int min, int extent, int valid_min,
                                 int fold_factor) {
    assert(false);
}
int halide_error_fold_factor_too_small(void *user_context,
                                       const char *func_name,
                                       const char *var_name, int fold_factor,
                                       const char *loop_name,
                                       int required_extent) {
    assert(false);
}
int halide_error_requirement_failed(void *user_context, const char *condition,
                                    const char *message) {
    assert(false);
}
...
int halide_error_no_device_interface(void *user_context) { assert(false); }
int halide_error_device_interface_no_device(void *user_context) {
    assert(false);
}
int halide_error_host_and_device_dirty(void *user_context) { assert(false); }
int halide_error_buffer_is_null(void *user_context, const char *routine) {
    assert(false);
}
int halide_error_integer_division_by_zero(void *user_context) { assert(false); }

void extracted_conv_3_3(void *_input, int32_t *_kernel, int32_t *_conv, int32_t _13, int32_t _16, int32_t _18) {
    int32_t _221 = _16 * _18;
    int32_t _222 = _221 + _13;
    for (int _conv_s1_y = 0; _conv_s1_y < 0 + 62; _conv_s1_y++) {
        for (int _conv_s1_x = 0; _conv_s1_x < 0 + 62; _conv_s1_x++) {
            int32_t _223 = _conv_s1_x - _222;
            int32_t _224 = _conv_s1_y * 62;
            int32_t _225 = _224 + _conv_s1_x;
            for (int _conv_s1_r__y = 0; _conv_s1_r__y < 0 + 3;
                 _conv_s1_r__y++) {
                int32_t _226 = _conv_s1_r__y * 3;
                int32_t _227 = _conv_s1_r__y + _conv_s1_y;
                int32_t _228 = _227 * _18;
                int32_t _229 = _228 + _223;
                for (int _conv_s1_r__x = 0; _conv_s1_r__x < 0 + 3;
                     _conv_s1_r__x++) {
                    int32_t _230 = _conv[_225];
                    int32_t _231 = _conv_s1_r__x + _226;
                    int32_t _232 = _kernel[_231];
                    int32_t _233 = _conv_s1_r__x + _229;
                    uint8_t _234 = ((const uint8_t *)_input)[_233];
                    uint16_t _235 = (uint16_t)(_234);
                    int32_t _236 = (int32_t)(_235);
                    int32_t _237 = _232 * _236;
                    int32_t _238 = _230 + _237;
                    _conv[_225] = _238;
                }  // for _conv_s1_r__x
            }      // for _conv_s1_r__y
        }          // for _conv_s1_x
...
int conv_3_3(struct halide_buffer_t *_input_buffer,
             struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS {
    ...
    if (_30) {
        struct halide_dimension_t *_31 =
            _halide_buffer_get_shape(_input_buffer);
        uint64_t _32 = (uint64_t)(0);
        void *_33 = (void *)(_32);
        struct halide_device_interface_t *_34 =
            (struct halide_device_interface_t *)(_32);
        struct {
            const int32_t f_0;
            const int32_t f_1;
            const int32_t f_2;
            ...
            const int32_t f_6;
            const int32_t f_7;
        } s0 = {0, 64, 1, 0, 0, 64, 64, 0};
        struct halide_dimension_t *_35 = (struct halide_dimension_t *)(&s0);
        struct halide_buffer_t *_36 = _halide_buffer_init(
            _input_buffer, _31, _33, _32, _34, 1, 8, 2, _35, _32);
        (void)_36;
    }  // if _30
    bool _37 = _halide_buffer_is_bounds_query(_output_buffer);
    if (_37) {
        struct halide_dimension_t *_38 =
            _halide_buffer_get_shape(_output_buffer);
        uint64_t _39 = (uint64_t)(0);
        void *_40 = (void *)(_39);
        struct halide_device_interface_t *_41 =
            (struct halide_device_interface_t *)(_39);
        struct {
            const int32_t f_0;
            const int32_t f_1;
            const int32_t f_2;
            ...
            const int32_t f_6;
            const int32_t f_7;
        } s1 = {0, 62, 1, 0, 0, 62, 62, 0};
        struct halide_dimension_t *_42 = (struct halide_dimension_t *)(&s1);
        struct halide_buffer_t *_43 = _halide_buffer_init(
            _output_buffer, _38, _40, _39, _41, 1, 8, 2, _42, _39);
        (void)_43;
    }  // if _37
    ...
    if (_47) {
        ...
        if (!_55) {
            ...
            int32_t _59 = halide_error_bad_type(_ucon, "Input buffer input", _9,
                                                _56, _10, _57, _11, _58);
            return _59;
        }
        bool _60 = _12 == 2;
        if (!_60) {
            int32_t _61 = halide_error_bad_dimensions(
                _ucon, "Input buffer input", _12, 2);
            return _61;
        }
        ...
        if (!_69) {
            ...
            int32_t _73 = halide_error_bad_type(_ucon, "Output buffer output",
                                                _20, _70, _21, _71, _22, _72);
            return _73;
        }
        bool _74 = _23 == 2;
        if (!_74) {
            int32_t _75 = halide_error_bad_dimensions(
                _ucon, "Output buffer output", _23, 2);
            return _75;
        }
        bool _76 = _13 <= 0;
        int32_t _77 = _14 + _13;
        ...
        if (!_79) {
            int32_t _80 = _14 + _13;
            int32_t _81 = _80 + -1;
            int32_t _82 = halide_error_access_out_of_bounds(
                _ucon, "Input buffer input", 0, 0, 63, _13, _81);
            return _82;
        }
        bool _83 = 0 <= _14;
        if (!_83) {
            int32_t _84 = halide_error_buffer_extents_negative(
                _ucon, "Input buffer input", 0, _14);
            return _84;
        }
        bool _85 = _16 <= 0;
        int32_t _86 = _17 + _16;
        ...
        if (!_88) {
            int32_t _89 = _17 + _16;
            int32_t _90 = _89 + -1;
            int32_t _91 = halide_error_access_out_of_bounds(
                _ucon, "Input buffer input", 1, 0, 63, _16, _90);
            return _91;
        }
        bool _92 = 0 <= _17;
        if (!_92) {
            int32_t _93 = halide_error_buffer_extents_negative(
                _ucon, "Input buffer input", 1, _17);
            return _93;
        }
        bool _94 = _24 <= 0;
        int32_t _95 = _25 + _24;
        ...
        if (!_97) {
            int32_t _98 = _25 + _24;
            int32_t _99 = _98 + -1;
            int32_t _100 = halide_error_access_out_of_bounds(
                _ucon, "Output buffer output", 0, 0, 61, _24, _99);
            return _100;
        }
        bool _101 = 0 <= _25;
        if (!_101) {
            int32_t _102 = halide_error_buffer_extents_negative(
                _ucon, "Output buffer output", 0, _25);
            return _102;
        }
        bool _103 = _27 <= 0;
        ...
        if (!_106) {
            ...
            int32_t _108 = _107 + -1;
            int32_t _109 = halide_error_access_out_of_bounds(
                _ucon, "Output buffer output", 1, 0, 61, _27, _108);
            return _109;
        }
        bool _110 = 0 <= _28;
        if (!_110) {
            int32_t _111 = halide_error_buffer_extents_negative(
                _ucon, "Output buffer output", 1, _28);
            return _111;
        }
        bool _112 = _15 == 1;
        if (!_112) {
            int32_t _113 = halide_error_constraint_violated(
                _ucon, "input.stride.0", _15, "1", 1);
            return _113;
        }
        bool _114 = _26 == 1;
        if (!_114) {
            int32_t _115 = halide_error_constraint_violated(
                _ucon, "output.stride.0", _26, "1", 1);
            return _115;
        }
        ...
        if (!_129) {
            ...
            int32_t _138 = halide_error_buffer_allocation_too_large(
                _ucon, "input", _136, _137);
            return _138;
        }
        ...
        if (!_149) {
            ...
            int32_t _160 = halide_error_buffer_allocation_too_large(
                _ucon, "input", _158, _159);
            return _160;
        }
        ...
        if (!_162) {
            ...
            int32_t _164 = halide_error_buffer_extents_too_large(_ucon, "input",
                                                                 _118, _163);
            return _164;
        }
        ...
        if (!_173) {
            ...
            int32_t _182 = halide_error_buffer_allocation_too_large(
                _ucon, "output", _180, _181);
            return _182;
        }
        ...
        if (!_193) {
            ...
            int32_t _204 = halide_error_buffer_allocation_too_large(
                _ucon, "output", _202, _203);
            return _204;
        }
        ...
        if (!_206) {
            ...
            int32_t _208 = halide_error_buffer_extents_too_large(
                _ucon, "output", _121, _207);
            return _208;
        }
        ...
        if (!_211) {
            int32_t _212 =
                halide_error_host_is_null(_ucon, "Input buffer input");
            return _212;
        }
        ...
        if (!_215) {
            int32_t _216 =
                halide_error_host_is_null(_ucon, "Output buffer output");
            return _216;
        }
        {
            int32_t _kernel[9];
            ...
            for (int _kernel_s0_y = 0; _kernel_s0_y < 0 + 3; _kernel_s0_y++) {
                int32_t _217 = _kernel_s0_y * 3;
                for (int _kernel_s0_x = 0; _kernel_s0_x < 0 + 3;
                     _kernel_s0_x++) {
                    int32_t _218 = _kernel_s0_x + _217;
                    _kernel[_218] = 0;
                }  // for _kernel_s0_x
            }      // for _kernel_s0_y
            _kernel[0] = 1;
            ...
            _kernel[8] = 1;
            {
                int32_t _conv[3844];
                // produce conv
                for (int _conv_s0_y = 0; _conv_s0_y < 0 + 62; _conv_s0_y++) {
                    int32_t _219 = _conv_s0_y * 62;
                    for (int _conv_s0_x = 0; _conv_s0_x < 0 + 62;
                         _conv_s0_x++) {
                        int32_t _220 = _conv_s0_x + _219;
                        _conv[_220] = 0;
                    }  // for _conv_s0_x
                }      // for _conv_s0_y
                // consume kernel
                ...
                std::cout << std::endl;
                std::cout << "_13: " << _13 << ", _16: " << _16 << ", _18: " << _18 << "\n";
                extracted_conv_3_3(_input, _kernel, _conv, _13, _16, _18);
                // int32_t _221 = _16 * _18;
                // int32_t _222 = _221 + _13;
                // for (int _conv_s1_y = 0; _conv_s1_y < 0 + 62; _conv_s1_y++)
                //{
                ...
                //} // for _conv_s1_x
                //} // for _conv_s1_y
                for (int _conv_s2_y = 0; _conv_s2_y < 0 + 62; _conv_s2_y++) {
                    int32_t _239 = _conv_s2_y * 62;
                    for (int _conv_s2_x = 0; _conv_s2_x < 0 + 62;
                         _conv_s2_x++) {
                        int32_t _240 = _conv_s2_x + _239;
                        int32_t _241 = _conv[_240];
                        int32_t _242 = _241 >> 4;
                        _conv[_240] = _242;
                    }  // for _conv_s2_x
                }      // for _conv_s2_y
                bool _243 = 0 <= _27;
                int32_t _244 = _28 + _27;
                bool _245 = _244 <= 62;
                bool _246 = _243 && _245;
                if (!_246) {
                    int32_t _247 = _28 + _27;
                    int32_t _248 = _247 + -1;
                    int32_t _249 = halide_error_explicit_bounds_too_small(
                        _ucon, "y", "output", 0, 61, _27, _248);
                    return _249;
                }
                bool _250 = 0 <= _24;
                int32_t _251 = _25 + _24;
                bool _252 = _251 <= 62;
                bool _253 = _250 && _252;
                if (!_253) {
                    int32_t _254 = _25 + _24;
                    int32_t _255 = _254 + -1;
                    int32_t _256 = halide_error_explicit_bounds_too_small(
                        _ucon, "x", "output", 0, 61, _24, _255);
                    return _256;
                }
                // produce output
                // consume conv
                for (int _output_s0_y = 0; _output_s0_y < 0 + 62;
                     _output_s0_y++) {
                    int32_t _257 = _output_s0_y * _29;
                    int32_t _258 = _output_s0_y * 62;
                    for (int _output_s0_x = 0; _output_s0_x < 0 + 62;
                         _output_s0_x++) {
                        int32_t _259 = _output_s0_x + _258;
                        int32_t _260 = _conv[_259];
                        uint8_t _261 = (uint8_t)(_260);
                        int32_t _262 = _output_s0_x + _257;
                        ((uint8_t *)_output)[_262] = _261;
                    }  // for _output_s0_x
                }      // for _output_s0_y
            }          // alloc _conv
        }              // alloc _kernel
...
int main(int argc, char **argv) {
    ...
    input = Halide::Tools::load_and_convert_image(args[1]);
    std::string hardware_name = args[0];

    std::cout << "Starting conv_3_3"
              << "\n";

    conv_3_3(input, output);

    std::cout << "Finished conv_3_3"
              << "\n";

    std::string output_filename = "output_" + hardware_name + ".png";

    std::cout << output_filename << "\n";

    Halide::Tools::convert_and_save_image(output, output_filename);
