; ModuleID = './test_01_vecmul_a_ir_4.bc'
source_filename = "./01_vecmul_a_ir_4.bc"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux_gnu"

define void @test_amirali(i8* nocapture align 8 dereferenceable(8) %retval, i8* noalias nocapture readnone %run_options, i8** noalias nocapture readonly %params, i8** noalias nocapture readonly %temps, i64* noalias nocapture readnone %prof_counters) #0 {
...
multiply.loop_body.dim.0:                         ; preds = %multiply.loop_body.dim.0, %multiply.loop_body.dim.0.lr.ph
  ...
  %4 = getelementptr inbounds [8 x float], [8 x float]* %2, i64 0, i64 %multiply.indvar.dim.02
  %5 = load float, float* %4, align 4
  %6 = getelementptr inbounds [8 x float], [8 x float]* %1, i64 0, i64 %multiply.indvar.dim.02
  %7 = load float, float* %6, align 4
  %8 = fmul float %5, %7
  %9 = getelementptr inbounds [8 x float], [8 x float]* %multiply, i64 0, i64 %multiply.indvar.dim.02
