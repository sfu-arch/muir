; ModuleID = './test_12_maxp_a_ir_4.bc'
source_filename = "./12_maxp_a_ir_4.bc"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux_gnu"

define void @test_12_maxp_a_ir_4(i8* nocapture align 8 dereferenceable(8) %retval, i8* noalias nocapture readnone %run_options, i8** noalias nocapture readonly %params, i8** noalias nocapture readonly %temps, i64* noalias nocapture readnone %prof_counters) #0 {
reduce-window.loop_body.dim.1.lr.ph:
  ...
  %2 = load i8*, i8** %1, align 8, !dereferenceable !2, !align !1
...
reduce-window.inner.loop_header.window.3.reduce-window.inner.loop_exit.window.3_crit_edge.us-lcssa.us.us: ; preds = %reduce-window.inner.loop_body.window.3.lr.ph.us
  %16 = getelementptr inbounds [1 x [8 x [8 x [1 x float]]]], [1 x [8 x [8 x [1 x float]]]]* %0, i64 0, i64 0, i64 %6, i64 %14, i64 0
...
reduce-window.loop_exit.dim.3:                    ; preds = %reduce-window.inner.loop_exit.window.2
  %26 = getelementptr inbounds [1 x [2 x [2 x [1 x float]]]], [1 x [2 x [2 x [1 x float]]]]* %reduce-window, i64 0, i64 0, i64 %reduce-window.indvar.dim.130, i64 %reduce-window.indvar.dim.227, i64 0
  ...
  br i1 %27, label %reduce-window.inner.loop_body.window.1.lr.ph, label %reduce-window.loop_exit.dim.2
...
reduce-window.loop_exit.dim.2:                    ; preds = %reduce-window.loop_exit.dim.3
  ...
  br i1 %28, label %reduce-window.loop_body.dim.2.lr.ph, label %reduce-window.loop_exit.dim.0
