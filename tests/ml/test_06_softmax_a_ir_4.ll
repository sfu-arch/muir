; ModuleID = './test_06_softmax_a_ir_4.bc'
source_filename = "./06_softmax_a_ir_4.bc"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux_gnu"

define void @test_06_softmax_a_ir_4(i8* nocapture align 8 dereferenceable(8) %retval, i8* noalias nocapture readnone %run_options, i8** noalias nocapture readonly %params, i8** noalias nocapture readonly %temps, i64* noalias nocapture readnone %prof_counters) #0 {
reduce.inner.loop_body.reduction_dim.1.lr.ph:
  %arg0.untyped = load i8*, i8** %params, align 8, !dereferenceable !0, !align !1
  %bitcast = bitcast i8* %arg0.untyped to [1 x [8 x float]]*
...
reduce.inner.loop_body.reduction_dim.1:           ; preds = %reduce.inner.loop_body.reduction_dim.1, %reduce.inner.loop_body.reduction_dim.1.lr.ph
  ...
  %2 = getelementptr inbounds [1 x [8 x float]], [1 x [8 x float]]* %bitcast, i64 0, i64 0, i64 %reduce.inner.indvar.reduction_dim.112
...
fusion.1.loop_body.dim.1.lr.ph:                   ; preds = %reduce.inner.loop_body.reduction_dim.1
  ...
  %fusion.1 = bitcast i8* %11 to [1 x [8 x float]]*
...
fusion.1.loop_body.dim.1:                         ; preds = %fusion.1.loop_body.dim.1, %fusion.1.loop_body.dim.1.lr.ph
  ...
  %12 = getelementptr inbounds [1 x [8 x float]], [1 x [8 x float]]* %bitcast, i64 0, i64 0, i64 %fusion.1.indvar.dim.18
  %13 = load float, float* %12, align 4
  %14 = load float, float* %9, align 4
  %15 = fsub float %13, %14
  %16 = call float @llvm.exp.f32(float %15)
  %17 = getelementptr inbounds [1 x [8 x float]], [1 x [8 x float]]* %fusion.1, i64 0, i64 0, i64 %fusion.1.indvar.dim.18
  store float %16, float* %17, align 4
  %invar.inc3 = add nuw nsw i64 %fusion.1.indvar.dim.18, 1
  %18 = icmp ugt i64 %invar.inc3, 7
...
reduce.1.inner.loop_body.reduction_dim.1:         ; preds = %reduce.1.inner.loop_body.reduction_dim.1, %reduce.1.inner.loop_body.reduction_dim.1.lr.ph
  ...
  %21 = getelementptr inbounds [1 x [8 x float]], [1 x [8 x float]]* %fusion.1, i64 0, i64 0, i64 %reduce.1.inner.indvar.reduction_dim.14
  %22 = load float, float* %21, align 4
  %23 = fadd float %20, %22
  %invar.inc6 = add nuw nsw i64 %reduce.1.inner.indvar.reduction_dim.14, 1
  %24 = icmp ugt i64 %invar.inc6, 7
...
fusion.loop_body.dim.0.lr.ph:                     ; preds = %reduce.1.inner.loop_body.reduction_dim.1
  ...
  %fusion = bitcast i8* %0 to [8 x float]*
...
fusion.loop_body.dim.0:                           ; preds = %fusion.loop_body.dim.0, %fusion.loop_body.dim.0.lr.ph
  ...
  %26 = getelementptr inbounds [1 x [8 x float]], [1 x [8 x float]]* %fusion.1, i64 0, i64 0, i64 %fusion.indvar.dim.02
  %27 = load float, float* %26, align 4
  %28 = load float, float* %25, align 4
  %29 = fdiv float %27, %28
  %30 = getelementptr inbounds [8 x float], [8 x float]* %fusion, i64 0, i64 %fusion.indvar.dim.02
  store float %29, float* %30, align 4
  %invar.inc12 = add nuw nsw i64 %fusion.indvar.dim.02, 1
  %31 = icmp ugt i64 %invar.inc12, 7
