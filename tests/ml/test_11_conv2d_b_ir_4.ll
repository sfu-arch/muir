; ModuleID = './test_11_conv2d_b_ir_4.bc'
source_filename = "./11_conv2d_b_ir_4.bc"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux_gnu"

define void @test_11_conv2d_b_ir_4(i8* nocapture align 8 dereferenceable(8) %retval, i8* noalias nocapture readnone %run_options, i8** noalias nocapture readonly %params, i8** noalias nocapture readonly %temps, i64* noalias nocapture readnone %prof_counters) #0 {
convolution.loop_body.dim.1.lr.ph:
  ...
  %arg1.untyped = load i8*, i8** %1, align 8, !dereferenceable !2, !align !3
  %2 = bitcast i8* %arg1.untyped to [3 x [3 x [1 x [2 x float]]]]*
  %3 = load i8*, i8** %temps, align 8, !dereferenceable !4, !align !1
...
convolution.inner.loop_header.iz.convolution.inner.loop_exit.iz_crit_edge.us-lcssa.us.us: ; preds = %convolution.inner.loop_body.iz.lr.ph.us
  ...
  %19 = getelementptr inbounds [1 x [64 x [64 x [1 x float]]]], [1 x [64 x [64 x [1 x float]]]]* %0, i64 0, i64 0, i64 %7, i64 %15, i64 0
...
convolution.inner.loop_exit.k0:                   ; preds = %convolution.inner.loop_exit.k1
  %27 = getelementptr inbounds [1 x [64 x [64 x [2 x float]]]], [1 x [64 x [64 x [2 x float]]]]* %convolution, i64 0, i64 0, i64 %convolution.indvar.dim.126, i64 %convolution.indvar.dim.223, i64 %convolution.indvar.dim.320
